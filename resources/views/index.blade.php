        ...
        <div class="container">
            ...
            <div class="about-items-second">
                ...
                <div class="right-block">
                    ...
                    <a href="#contacts"><input type="button" class="button-white right-block_button" value="Связаться с нами"></a>
                </div>
            </div>
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu hide">
                                ...
                                <li><a href="{{ route('direction', !empty($service->url_static) ? $service->url_static : $service->url ) }}">{{ $direction->title }}</a></li>
                                @endforeach
                                @if(false)
