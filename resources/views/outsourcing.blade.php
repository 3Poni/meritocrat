...
@endpush
@section('title')Кадровый аутсорсинг@endsection
@section('content')
    <section class="outsourcing-page">
      <div class="container">
          <div class="links">
              ...
              <img src="../img/arrow.png" alt="">
              <a href="{{ route('service', $direction->service->url) }}"><span class="active-link">{{ $direction->service->header }}</span></a>
              <img src="../img/arrow.png" alt="">
              <a href="{{ route('direction', $direction->url_static ) }}"><span class="active-link">{{ $direction->header }}</span></a>
          </div>
